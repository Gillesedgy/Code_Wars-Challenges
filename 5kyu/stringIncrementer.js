...
function incrementString(strng) {
  ...
  if (isNumber) {
    ...
    const leadingZeros =
      numberPartLength > increasedNumberStrng.length
        ? "0".repeat(numberPartLength - increasedNumberStrng.length)
        : "";

    // new string variable  incremented
    newStrng =
      strng.slice(0, -numberPartLength) + leadingZeros + increasedNumberStrng;
